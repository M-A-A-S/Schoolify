...
namespace Schoolify.Common.DTOs.Classroom
{
    public class ClassroomDTO
    {
        public int Id { get; set; }

        [Display(Name = nameof(Resources.SharedResource.RoomType),
...
ErrorMessageResourceType = typeof(Resources.SharedResource)
        ...
        [Display(Name = nameof(Resources.SharedResource.Capacity),
ResourceType = typeof(Resources.SharedResource)
)]
        [Required(
ErrorMessageResourceName = nameof(Resources.SharedResource.Required),
ErrorMessageResourceType = typeof(Resources.SharedResource)
        ...
        public ClassroomTypeDTO? RoomType { get; set; }
    }
}
