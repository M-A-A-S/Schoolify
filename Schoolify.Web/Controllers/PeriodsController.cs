...
namespace Schoolify.Web.Controllers
{
    public class PeriodsController : Controller
    {
        ...
        {
            var findAllPeriodsResult = await _service.GetAllAsync();
            return View(findAllPeriodsResult.Data);
        }
        ...
        public async Task<IActionResult> Create(PeriodDTO DTO)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(PeriodDTO DTO)
        {
            if (!ModelState.IsValid)
            {
                await LoadSchoolYears();
