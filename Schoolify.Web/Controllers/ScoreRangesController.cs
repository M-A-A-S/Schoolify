...
{
    public class ScoreRangesController : Controller
    {

        private readonly IScoreRangeService _service;
        private readonly IStringLocalizer<SharedResource> _localizer;

        public ScoreRangesController(IScoreRangeService service,
        ...
        {
            var findAllScoreRangesResult = await _service.GetAllAsync();
            return View(findAllScoreRangesResult.Data);
        }
        ...
        public async Task<IActionResult> Create(ScoreRangeDTO DTO)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(ScoreRangeDTO DTO)
        {
            if (!ModelState.IsValid)
            {
                TempData["Error"] = _localizer["ValidationError"].Value;
